...
namespace StaplePuck.Data.Migrations
{
    ...
    [Migration("20190326042932_ScoringUpdate")]
    partial class ScoringUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaplePuck.Core.Scoring.FantasyTeamScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("LeagueScoreId");

                    b.ToTable("FantasyTeamScores");
                });

            modelBuilder.Entity("StaplePuck.Core.Scoring.LeagueScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StaplePuck.Core.Scoring.FantasyTeamScore", b =>
                {
                    b.HasOne("StaplePuck.Core.Fantasy.FantasyTeam", "FantasyTeam")
                        .WithOne("FantasyTeamScore")
                        .HasForeignKey("StaplePuck.Core.Scoring.FantasyTeamScore", "FantasyTeamId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("StaplePuck.Core.Scoring.LeagueScore")
                        .WithMany("FantasyTeamScores")
                        .HasForeignKey("LeagueScoreId");
                });
